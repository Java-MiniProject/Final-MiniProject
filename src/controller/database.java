...
public class database {
   ...
   public String[] getcategories(){
      try{
         ...
         int i = 0;
         while(rst.next()) {
            categories[i] = rst.getString("name");
            i++;
         }
         return categories;
      }
   ...
   public boolean register(String fname, String username, String lname, String email, String password,
      ...
      try {
         if (password.equals(Cpassword)) {
            String query = "INSERT INTO users(id,username,password,id_books,email,date_a, date_b, first_name, last_name) VALUES ( null ,'"
                  + username + "','" + password + "', null,'"+email+" ',null,null,'" + fname
                  + "','" + lname + "')";
